...
import com.galkon.io.bzip2.BZip2Decompressor;
...
public class Archive {
	...
	public byte[] recompile() throws IOException {
		...
		RSByteArrayOutputStream finalBuf = new RSByteArrayOutputStream();
	...
	private byte[] compileUncompressed() throws IOException {
		RSByteArrayOutputStream fileData = new RSByteArrayOutputStream();
		...
		fileData.close();
		RSByteArrayOutputStream fileInfo = new RSByteArrayOutputStream();
		...
		fileInfo.close();
		RSByteArrayOutputStream finalBuffer = new RSByteArrayOutputStream();
